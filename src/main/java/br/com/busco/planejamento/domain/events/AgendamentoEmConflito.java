...
@AllArgsConstructor
@NoArgsConstructor
public class AgendamentoEmConflito implements DomainEvent {
    @NotNull(message = "O parâmetro 'id' é obrigatório!")
    private AgendamentoOperacionalId id;
    private Instant occurredOn;

    public static AgendamentoEmConflito of(AgendamentoOperacional agendamento) {
        return new AgendamentoEmConflito(agendamento.getId(), Instant.now());
    }
}
